...
function (_Slider) {
  ...
  function SliderMini(next, prev, container, activeClass, animate, autoplay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, next, prev, container, activeClass, animate, autoplay));
  }
  ...
  _createClass(SliderMini, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        _this.item = _this.slides.splice(_this.slides.length - 1, 1)[0];

        _this.slides.unshift(_this.item);

        _this.container.insertBefore(_this.item, _this.slides[1]);
    ...
    value: function nextSlide() {
      ...
      this.next.addEventListener('click', function () {
        ...
        _this2.item = _this2.slides.splice(0, 1)[0];

        _this2.slides.splice(_this2.slides.length, 1, _this2.item);
...
var Slider = function Slider() {
  ...
  this.x = function () {
    _this.container.children.forEach(function (item) {
      if (item.tagName != 'BUTTON') {
        _this.slides.push(item);
      }
    });
  };
